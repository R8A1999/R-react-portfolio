    ...
    <div name="About" className="p-10 w-full">
      <div className="max-w-screen-lg mx-auto py-20 h-full px-4">
        ...
        <p className="text-lg pt-4">
          I am a full stack developer with over 1 year 5months of hands-on experience,
           My expertise lies in leveraging frameworks like NextJS
          and ReactJS to design, develop, and test responsive web applications.
           My passion for innovation drove me to develop a
          ...
          I don't have much hands-on experience using tailwind but some konwledge by doing small projects.
        </p>
        <br />
